const cacheName = "taamen-2026-v6-maintenance-gate";
...
const assets = [
  ...
  "./maintenance/maintenance-config.js",
  "./maintenance/maintenance-content.js",
...
self.addEventListener("fetch", event => {
  ...
  /*
   * External resources:
   * network first, cached copy only as a fallback.
   */
  ...
  /*
   * IMPORTANT:
   * HTML navigation is now NETWORK-FIRST.
   *
   * This prevents GitHub Pages visitors from remaining
   * trapped on a stale index.html after maintenance ends.
   */
  if (
            ...
            cached =>
              ...
              caches.match("./index.html").then(
                fallback =>
                  fallback ||
                  new Response(
                    "TAAMEN is temporarily unavailable.",
                    {
                      status: 503,
                      headers: {
